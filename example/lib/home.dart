...
class _HomeState extends State<Home> {
  ...
  Map<String, String> instruments = {
    ...
    'Bass Guitar': 'explorer.png',
    'Drum Set': 'drums.jpg',
    'Electric Guitar': 'electricguitar.png'
  };
  @override
  void initState() {
                    ...
                    child: ListView(
                      ...
                      children: instruments.keys.map((f){
                        return FlatButton(
                          ...
                          child: Column(
                            children: <Widget>[
                              Image.asset('assets/${instruments[f]}', height: 150,),
                              Text(f)
                            ],
                          ),
                        );
                  ...
                  children: <Widget>[
                    SwitchListTile(
                      ...
                      onChanged: (value){
                        print(val);
                        setState(() {
                          CustomTheme.themdata = value? ThemeData.dark(): ThemeData.light();
                          val = !val;
                        });
                      },
                    )
